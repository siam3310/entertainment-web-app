...
export function getData(endpoint, page) {
  return axios.get(
    `${BASE_URL}/${endpoint}?api_key=${process.env.API_KEY}&page=${page || 1}`
  );
}

export function getMovieDetail(id) {
  return axios.get(`${BASE_URL}/movie/${id}?api_key=${process.env.API_KEY}`);
}

export function getMovieCasts(id) {
  return axios.get(
    `${BASE_URL}/movie/${id}/credits?api_key=${process.env.API_KEY}`
  );
}

export function getTvDetail(id) {
  return axios.get(`${BASE_URL}/tv/${id}?api_key=${process.env.API_KEY}`);
}

export function getTvCasts(id) {
  return axios.get(
    `${BASE_URL}/tv/${id}/credits?api_key=${process.env.API_KEY}`
  );
}
...
export function getSimilarTvSeries(id) {
  return axios.get(
    `${BASE_URL}/tv/${id}/similar?api_key=${process.env.API_KEY}&language=en-US&page=1`
  );
}
